...
namespace Assets.Scripts.CameraComponents
{
    internal class TargetFollower : MonoBehaviour
    {
        ...
        {
            transform.position = new Vector3(_target.transform.position.x + _offsetPositionX, _target.transform.position.y + _offsetPositionY, _target.transform.position.z + _offsetPositionZ);
        }
